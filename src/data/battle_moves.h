const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_NATURE_POWER] =
    {
        ...
        .priority = 0,
        .flags = 0,
        .moveType = MOVE_TYPE_SPECIAL, // Actually status, but all potential moves are special
    },
